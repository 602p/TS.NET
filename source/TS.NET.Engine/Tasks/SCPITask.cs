...
namespace TS.NET.Engine
{
    internal class SCPITask
    {
        ...
        public void Start(ILoggerFactory loggerFactory, Thunderscope scope)
        {
            ...
            taskLoop = Task.Factory.StartNew(() => Loop(logger, scope, cancelTokenSource.Token), TaskCreationOptions.LongRunning);
        }
        ...
        private static void Loop(ILogger logger, Thunderscope scope, CancellationToken cancelToken)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    String? r = ProcessSCPICommand(logger, scope, command);
        ...
        public static String? ProcessSCPICommand(ILogger logger, Thunderscope scope, String fullCommand) {
