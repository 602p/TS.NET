...
namespace TS.NET
{
    ...
    public class SharedMemoryThunderscopeBridgeReader : IThunderscopeBridgeReader
    {
        ...
        public unsafe SharedMemoryThunderscopeBridgeReader(ThunderscopeBridgeOptions options, ILoggerFactory loggerFactory)
        {
